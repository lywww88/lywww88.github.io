...
<!-- Bootstrap Icons (如全站已引入可删除这一行) -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">

<style>
  .contact-hero {
    display:flex; align-items:center; gap:.6rem; margin:1.2rem 0 1.6rem;
  }
...
<div class="contact-card">
  ...
  <!-- ✅ 替换成你的 Formspree 端点；示例：https://formspree.io/f/abcdwxyz -->
  ...
  (function(){
    ...
    form.addEventListener('submit', async function(e){
      ...
      try {
        ...
        // 若未替换 Formspree 端点，直接 fallback 到 mailto
        if (endpoint.includes('FORM_ENDPOINT')) {
          window.location.href = 'mailto:yiweilu36@uci.edu?subject=' + encodeURIComponent(data.get('subject') || 'Website Contact') +
