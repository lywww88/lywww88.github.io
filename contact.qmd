...
<style>
  ...
  .contact-card {
    max-width: 720px; margin: 0 auto; padding: 1.25rem 1.25rem 1.6rem;
  ...
  input, textarea, select {
    padding:.65rem .75rem; border:1px solid #ced4da; border-radius:10px; font-size:1rem;
  }
  ...
  .btn-primary {
    ...
    border: none; background:#0d6efd; color:#fff; font-weight:600; cursor:pointer;
  }
