...
<section id="jj-summary" style="max-width:1000px;margin:2em auto;padding:0 1em;">
  ...
  <p style="color:#2c3e50;line-height:1.85;font-size:1.05rem;">
    Partnered with <strong>Johnson &amp; Johnson – Cerenovus</strong> to build a data-driven retention program 
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin-bottom:1.2em;">
    <div style="border:1px solid #e7ecf3;border-radius:12px;padding:1em;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,.03);">
      <div style="color:#6c7a89;font-size:.92rem;">Churn Model AUC</div>
      <div style="color:#0d6efd;font-size:1.5rem;font-weight:800;">0.86</div>
    </div>
    <div style="border:1px solid #e7ecf3;border-radius:12px;padding:1em;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,.03);">
      <div style="color:#6c7a89;font-size:.92rem;">Top-Decile Capture</div>
      <div style="color:#0d6efd;font-size:1.5rem;font-weight:800;">62%</div>
    </div>
    <div style="border:1px solid #e7ecf3;border-radius:12px;padding:1em;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,.03);">
      <div style="color:#6c7a89;font-size:.92rem;">Projected ROI (Annual)</div>
      <div style="color:#0d6efd;font-size:1.5rem;font-weight:800;">+$1.2M</div>
    </div>
    <div style="border:1px solid #e7ecf3;border-radius:12px;padding:1em;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,.03);">
      <div style="color:#6c7a89;font-size:.92rem;">Retention Uplift</div>
      <div style="color:#0d6efd;font-size:1.5rem;font-weight:800;">+7.8%</div>
    </div>
  </div>
  ...
  <details style="margin:.6em 0;">
    ...
    <ul>
      ...
      <li>Projected +$1.2M annual ROI from targeted campaigns.</li>
